...
<template>
    <GanttComponent :height :dataSource="resourceData" :taskFields :allowSelection :resourceFields :taskType
        :editSettings :toolbar :treeColumnIndex :resources="resourceResources" :highlightWeekends :columns
        :labelSettings :projectStartDate :projectEndDate :splitterSettings :showOverAllocation>
    </GanttComponent>
</template>