...
<template>
    <GanttComponent ref='gantt' id="labelData" :dataSource="timelineTemplateData" :rowHeight="46" :height
        :highlightWeekends :allowSelection :taskFields :labelSettings
        :columns="columns" :splitterSettings :projectStartDate
        :timelineSettings
        :projectEndDate
