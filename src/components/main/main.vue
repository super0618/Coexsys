...
<template>
    <GanttComponent :height :dataSource="editingData" :dateFormat :taskFields :editSettings :toolbar :allowSelection
        :gridLines :treeColumnIndex :resourceFields :resources="editingResources" :highlightWeekends :timelineSettings
        :columns :eventMarkers :labelSettings :editDialogFields :projectStartDate :projectEndDate :splitterSettings>
    </GanttComponent>
</template>
