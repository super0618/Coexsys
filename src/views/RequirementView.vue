...
const hostUrl = "https://services.syncfusion.com/vue/production/api/documenteditor/",
  ...
  save = function (format: any) {
    doceditcontainer.value.ej2Instances.documentEditor.save(
      doceditcontainer.value.ej2Instances.documentEditor.documentName === ""
        ? "sample"
        : doceditcontainer.value.ej2Instances.documentEditor.documentName,
      format
    );
  ...
  titleBarKeydownEvent = function (e: any) {
    if (e.keyCode === 13) {
      e.preventDefault();
  ...
  titleBarBlurEvent = function (args: any) {
    if (document.getElementById("documenteditor_title_contentEditor").textContent === "") {
      document.getElementById("documenteditor_title_contentEditor").textContent = "Document1";
    }
    document.getElementById("documenteditor_title_contentEditor").contentEditable = "false";
